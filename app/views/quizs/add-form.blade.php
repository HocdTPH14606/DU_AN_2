...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= BASE_URL . 'mon-hoc' ?>">Danh sách</a></li>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control">
                        <label class="radio-inline"><input name="status" value="0" type="radio" checked> Ẩn </label>
                        <label class="radio-inline"><input name="status" value="1" type="radio"> Hiện </label>
                    </div>
                </div>
                <div class="form-group">
                    <label for="input">Xáo trộn</label>
                    <div class="form-control">
                        <label class="radio-inline"><input name="is_shuffle" value="0" type="radio" checked> Có </label>
                        <label class="radio-inline"><input name="is_shuffle" value="1" type="radio"> Không </label>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
