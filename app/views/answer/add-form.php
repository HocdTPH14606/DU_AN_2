...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <form action="<?= BASE_URL . 'answer/luu-tao-moi?question_id=' . $question->id ?>" method="post" id="demoForm" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control">
                                            <label class="radio-inline"><input name="is_correct" value="0" type="radio" checked> Sai </label>
                                            <label class="radio-inline"><input name="is_correct" value="1" type="radio"> Đúng </label>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                        <label for="input">Đáp án đúng</label>
                                        <div class="form-control">
                                            <label class="radio-inline"><input name="is_correct" value="0" type="radio"></label>
                                         </div>
                                    </div> -->
                                    <!-- <div class="form-group">
